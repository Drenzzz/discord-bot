# **Kaicyy AI Helper - Discord Bot** 🤖

**Kaicyy AI Helper** is an AI-powered Discord bot that can answer questions using DeepSeek AI and provides other commands like `/ping`, `/stats`, and `/help`.
